...
/* Obtem avisos do usuário atual por id */
exports.get_aviso_by_id = async (req, res, next) => {
    try {
        ...
        let aviso = await Aviso.find(req.query).populate('fotos');
        // Retorna os avisos:
        res.status(200).json(aviso[0] || {});
